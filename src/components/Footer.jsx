    ...
    <footer className="bg-sovera-dark text-ivory-100">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-[0.15em] text-gold mb-6 font-[500]">Collections</h4>
            <ul className="space-y-3">
              {footerLinks.collections.map((link) => (
                <li key={link.name}>
                  <Link to={link.path} className="text-sm text-ivory-300/70 hover:text-gold transition-colors duration-300">{link.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          <div>
            <h4 className="text-xs uppercase tracking-[0.15em] text-gold mb-6 font-[500]">Explore</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-[0.15em] text-gold mb-6 font-[500]">Support</h4>
            <ul className="space-y-3">
      ...
      <div className="border-t border-ivory-300/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-ivory-300/40 tracking-wider">&copy; {new Date().getFullYear()} SOVÉRA. All rights reserved.</p>
          <div className="flex gap-6">
            <a href="#" className="text-xs text-ivory-300/40 hover:text-gold transition-colors tracking-wider">Privacy Policy</a>
            <a href="#" className="text-xs text-ivory-300/40 hover:text-gold transition-colors tracking-wider">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
